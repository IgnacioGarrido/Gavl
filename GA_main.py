...
Example call:
    best_chrom, historic_fitness, pop = GA_vl(num_individuals = 100, df = mast_np, min_number_of_genes = 3, max_number_of_genes = 5, PENALIZATION_LENGTH = 7000, max_gen = 50)
"""
from GA_functions.aux_functions import get_master_np, index_to_colname
